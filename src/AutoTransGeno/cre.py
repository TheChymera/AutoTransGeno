...
def cre(datadir, feature_name, extract_from):
	...
	add_to_track(primer_features, datadir+"cre_fw2.fasta", main_record_file, annotation="cre_fw2", feature_color=colors.darkorchid, label_angle=60)
	add_to_track(primer_features, datadir+"cre_rv2.fasta", main_record_file, annotation="cre_rv2", feature_color=colors.darkorchid, label_angle=60)
	add_to_track(primer_features, datadir+"cre_fw3.fasta", main_record_file, annotation="cre_fw3", feature_color=colors.salmon, label_angle=60)
	add_to_track(primer_features, datadir+"cre_rv3.fasta", main_record_file, annotation="cre_rv3", feature_color=colors.salmon, label_angle=60)
	add_to_track(primer_features, datadir+"cre_f1.fasta", main_record_file, annotation="cre_f1", feature_color=colors.cornflower, label_angle=60)
